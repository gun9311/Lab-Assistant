...
export const addSubject = (subjectData: SubjectData) => api.post('/subjects/add-subject', subjectData);
export const addUnits = (unitData: UnitData) => api.post('/subjects/add-units', unitData);
