...
import { Container, Typography, Paper, List, ListItem, ListItemText, ListItemIcon, Box, Badge, Button } from '@mui/material';
...
const NotificationsPage: React.FC = () => {
  ...
  return (
    <Container component="main" maxWidth="sm" sx={{ marginTop: { xs: 4, sm: 8 } }}>
