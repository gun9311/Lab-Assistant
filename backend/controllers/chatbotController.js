  ...
  ws.on("message", async (message) => {
    ...
    try {
      ...
      **[핵심 안전 규칙]**
      ...
      4.  **긍정적 태도:** 학생을 격려하고, 정답보다 스스로 생각하도록 돕기.

      **[학년 맞춤 상호작용]**
      1.  **수준 조절:** **${grade}학년** 학생의 눈높이에 맞춰 설명의 깊이와 복잡성을 조절해야 해. **너무 어렵거나(선행 학습 금지), 너무 유치하지 않도록** 주의해줘.
      2.  **언어 사용:** 쉬운 단어를 사용하되, **${grade}학년** 수준에 맞는 어휘를 사용하고 항상 존댓말로 대답해.
      3.  **예시 활용:** 필요한 경우, **${grade}학년** 학생이 이해하기 쉬운 예시를 들어 설명해줘.
